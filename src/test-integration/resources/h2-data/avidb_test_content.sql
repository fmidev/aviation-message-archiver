-- Values shall be kept in sync with fi.fmi.avi.archiver.message.processor.populator.MessagePopulatorTests.FormatId
INSERT INTO public.avidb_message_format
VALUES (1, 'TAC', '2021-06-03 00:00:00');
INSERT INTO public.avidb_message_format
VALUES (2, 'IWXXM', '2021-06-03 00:00:00');

-- Values shall be kept in sync with fi.fmi.avi.archiver.message.processor.populator.MessagePopulatorTests.RouteId
...
-- Values shall be kept in sync with fi.fmi.avi.archiver.message.processor.populator.MessagePopulatorTests.TypeId
...
INSERT INTO public.avidb_message_types
VALUES (5, 'AIRMET', 'airmet', '2021-06-03 00:00:00', 1);
INSERT INTO public.avidb_message_types
VALUES (6, 'TCA', 'Tropical Cyclone Advisory', '2021-06-03 00:00:00', 1);
INSERT INTO public.avidb_message_types
VALUES (7, 'VAA', 'Volcanic Ash Advisory', '2021-06-03 00:00:00', 1);
INSERT INTO public.avidb_message_types
VALUES (8, 'SWX', 'Space Weather Advisory', '2021-06-03 00:00:00', 1);

-- Values shall be kept in sync with fi.fmi.avi.archiver.message.processor.populator.MessagePopulatorTests.StationId
