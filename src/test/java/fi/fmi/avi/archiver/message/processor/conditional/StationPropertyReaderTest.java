...
class StationPropertyReaderTest {
    ...
    void testGetPropertyName() {
        ...
        final fi.fmi.avi.archiver.message.processor.conditional.StationPropertyReader reader //
                = new fi.fmi.avi.archiver.message.processor.conditional.StationPropertyReader();
