...
class TypePropertyReaderTest {
    ...
    void testGetPropertyName() {
        ...
        final fi.fmi.avi.archiver.message.processor.conditional.TypePropertyReader reader //
                = new fi.fmi.avi.archiver.message.processor.conditional.TypePropertyReader(ImmutableBiMap.of());
