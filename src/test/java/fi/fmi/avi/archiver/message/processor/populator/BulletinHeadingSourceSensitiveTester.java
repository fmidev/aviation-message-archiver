...
public abstract class BulletinHeadingSourceSensitiveTester<T> {
    ...
    final void readValue_returns_first_found_value_in_order_of_bulletinHeadingSources(
            final int actualIndex, final List<BulletinHeadingSource> bulletinHeadingSources) {
