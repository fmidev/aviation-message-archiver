...
class OriginatorPropertyReaderTest {
    ...
    void testGetPropertyName(final List<BulletinHeadingSource> bulletinHeadingSources) {
        ...
        final fi.fmi.avi.archiver.message.processor.conditional.OriginatorPropertyReader reader //
                = new fi.fmi.avi.archiver.message.processor.conditional.OriginatorPropertyReader(bulletinHeadingSources);
