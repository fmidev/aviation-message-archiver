...
class ProductIdPropertyReaderTest {
    ...
    void testGetPropertyName() {
        ...
        final fi.fmi.avi.archiver.message.populator.conditional.ProductIdPropertyReader reader //
                = new fi.fmi.avi.archiver.message.populator.conditional.ProductIdPropertyReader(ImmutableBiMap.of());
