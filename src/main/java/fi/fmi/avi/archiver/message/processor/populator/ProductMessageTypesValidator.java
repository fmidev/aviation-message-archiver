...
public class ProductMessageTypesValidator implements MessagePopulator {
     ...
     *
     * @param typeIds             mapping from message type to database id
     * @param aviationProducts    configured aviation products indexed by {@link AviationProduct#getId() product id}
     * @param productMessageTypes mapping from product id to message types allowed for the product
     */
    ...
    public void populate(final MessageProcessorContext context, final ArchiveAviationMessage.Builder target) {
        ...
        MessageProcessorHelper.tryGetInt(target, ArchiveAviationMessage.Builder::getType).ifPresent(type -> {
