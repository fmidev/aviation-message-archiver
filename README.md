...
- TAC format message types that are supported
  ...
  library [
  `TAC_TO_GENERIC_AVIATION_WEATHER_MESSAGE_POJO`](https://github.com/fmidev/fmi-avi-messageconverter-tac/blob/fmi-avi-messageconverter-tac-7.0.0/src/main/java/fi/fmi/avi/converter/tac/conf/TACConverter.java)
  conversion and
- IWXXM format message types that are supported
  ...
  library [
  `IWXXM_STRING_TO_GENERIC_AVIATION_WEATHER_MESSAGE_POJO`](https://github.com/fmidev/fmi-avi-messageconverter-iwxxm/blob/fmi-avi-messageconverter-iwxxm-6.0.0/src/main/java/fi/fmi/avi/converter/iwxxm/conf/IWXXMConverter.java)
  conversion.
...
4. Start the application. Replace
   ...
   java \
     ...
     -jar target/aviation-message-archiver-1.3.1-SNAPSHOT-bundle.jar
   ```
...
- **config:**
    ...
    - `message-type-location-indicator-types` (optional) - Message type-specific list of location indicator types in
      ...
      types are specified
      in [GenericAviationWeatherMessage.LocationIndicatorType](https://github.com/fmidev/fmi-avi-messageconverter/blob/fmi-avi-messageconverter-8.0.0/src/main/java/fi/fmi/avi/model/GenericAviationWeatherMessage.java)
      enum.
...
- `format-ids`:
  Map [
  `GenericAviationWeatherMessage.Format.name()`](https://github.com/fmidev/fmi-avi-messageconverter/blob/fmi-avi-messageconverter-8.0.0/src/main/java/fi/fmi/avi/model/GenericAviationWeatherMessage.java)
  to database column `avidb_message_format.format_id`.
- `type-ids`:
  Map [
  `MessageType.name()`](https://github.com/fmidev/fmi-avi-messageconverter/blob/fmi-avi-messageconverter-8.0.0/src/main/java/fi/fmi/avi/model/MessageType.java)
